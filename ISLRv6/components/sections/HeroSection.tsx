...
const HeroSection: React.FC<HeroSectionProps> = ({ contentReady, isLoading, onTrySignEaseIntent }) => {
          ...
          >
            <Link href="/sign-detection" passHref legacyBehavior>
              <StarBorder
                ...
                color="#e879f9"
                speed="5s"
                onMouseEnter={onTrySignEaseIntent}
                onFocus={onTrySignEaseIntent}
                onTouchStart={onTrySignEaseIntent}
              >
