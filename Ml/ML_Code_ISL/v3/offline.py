...
def get_prediction(prediction_fn, pq_file):
    ...
    tts.tts_to_file(text=f'The predicted sign is {sign}', file_path="output.mp3")
    #os.system("mpg321 output.mp3")  # Play the generated audio file
    # Play the audio file using subprocess
    try:
        subprocess.run(["mpg321", "output.mp3"], check=True)
